  ...
  <div class="text-center max-w-lg mx-auto">
    ...
    <div class="relative inline-block mb-8 select-none">
      ...
      <p class="relative text-[9rem] font-black leading-none tracking-tighter text-transparent bg-clip-text"
         style="background-image:linear-gradient(135deg,#10b981 0%,#34d399 50%,#6ee7b7 100%);">400</p>
    </div>

    <h1 class="text-2xl font-bold mb-3">Bad Request</h1>
    <p class="text-slate-400 mb-8 leading-relaxed">
      Something was wrong with that request &mdash; it couldn&rsquo;t be understood by the server.
      Double-check what you sent and try again.
    </p>
