...
$stmt = $pdo->prepare(
    'SELECT l.business_name, l.status, l.created_at
     FROM utiligo_leads l
     JOIN utiligo_lead_searches s ON l.search_id = s.id
     WHERE s.user_id = ?
...
<div class="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
  ...
  <div class="group relative glass rounded-2xl p-5 border border-white/5 overflow-hidden hover:border-emerald-500/30 transition-all hover:-translate-y-0.5">
    ...
    <div class="w-9 h-9 rounded-xl bg-emerald-500/15 flex items-center justify-center mb-4">
    ...
    <p class="text-4xl font-black text-white"><?= $leadCount ?></p>
  ...
  <div class="group relative glass rounded-2xl p-5 border border-white/5 overflow-hidden hover:border-blue-500/30 transition-all hover:-translate-y-0.5">
    ...
    <div class="w-9 h-9 rounded-xl bg-blue-500/15 flex items-center justify-center mb-4">
    ...
    <p class="text-4xl font-black text-white"><?= $sitesCount ?></p>
  ...
  <div class="group relative glass rounded-2xl p-5 border border-white/5 overflow-hidden hover:border-amber-500/30 transition-all hover:-translate-y-0.5">
    ...
    <div class="w-9 h-9 rounded-xl bg-amber-500/15 flex items-center justify-center mb-4">
    ...
    <p class="text-4xl font-black text-white"><?= $dealsWon ?></p>
  ...
  <div class="group relative glass rounded-2xl p-5 border border-white/5 overflow-hidden hover:border-violet-500/30 transition-all hover:-translate-y-0.5">
    ...
    <div class="w-9 h-9 rounded-xl bg-violet-500/15 flex items-center justify-center mb-4">
      <i class="fa-solid fa-dollar-sign text-violet-400 text-sm"></i>
    </div>
...
<div class="mb-8">
  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
    ...
    <a href="/portal/leads.php"
       class="group flex items-center gap-3 glass rounded-2xl px-4 py-4 border border-white/5 hover:border-emerald-500/40 hover:-translate-y-0.5 transition-all">
      ...
      <div>
        <p class="font-semibold text-sm">Find Leads</p>
        <p class="text-slate-500 text-xs">Search any city</p>
      </div>
    </a>

    <a href="/portal/generate.php"
       class="group flex items-center gap-3 glass rounded-2xl px-4 py-4 border border-white/5 hover:border-blue-500/40 hover:-translate-y-0.5 transition-all">
      ...
      <div>
        <p class="font-semibold text-sm">Generate Site</p>
        <p class="text-slate-500 text-xs">60-second build</p>
      </div>
    </a>

    <a href="/portal/my_sites.php"
       class="group flex items-center gap-3 glass rounded-2xl px-4 py-4 border border-white/5 hover:border-amber-500/40 hover:-translate-y-0.5 transition-all">
      ...
      <div>
        <p class="font-semibold text-sm">My Sites</p>
        <p class="text-slate-500 text-xs">Manage & share</p>
      </div>
    </a>

    <a href="/portal/settings.php"
       class="group flex items-center gap-3 glass rounded-2xl px-4 py-4 border border-white/5 hover:border-violet-500/40 hover:-translate-y-0.5 transition-all">
      ...
      <div>
        <p class="font-semibold text-sm">White-Label</p>
        <p class="text-slate-500 text-xs">Customize brand</p>
      </div>
    </a>
...
<div class="glass rounded-2xl border border-white/5 overflow-hidden">
  ...
  <div class="px-6 py-12 text-center">
    ...
    <p class="text-slate-600 text-sm mt-1">Start by finding your first leads below.</p>
    <a href="/portal/leads.php"
       class="inline-flex items-center gap-2 mt-4 bg-emerald-500 hover:bg-emerald-400 text-slate-950 px-5 py-2 rounded-xl text-sm font-bold">
  ...
  <ul class="divide-y divide-white/5">
    ...
    <li class="flex items-center gap-4 px-6 py-3.5 hover:bg-white/2 transition group">
      <div class="w-2 h-2 rounded-full <?= statusDot($a['status']) ?> shrink-0"></div>
      <div class="flex-1 min-w-0">
        <p class="font-medium text-sm truncate"><?= htmlspecialchars($a['business_name']) ?></p>
      </div>
