...
define('FREE_GENERATE_DAILY_LIMIT', 1);   // max sites a free user can generate per 24-hour window
define('FREE_TEMPLATE_LIMIT', 2);         // number of templates available to free users (first N in SITE_TEMPLATES)
